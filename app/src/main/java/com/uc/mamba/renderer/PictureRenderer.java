...
public class PictureRenderer implements GLSurfaceView.Renderer, PictureDataSource.OnTextureAvailableListener {
    private GLSurfaceView mGLSurfaceView;
    VideoFps videoFps = new VideoFps();
    ...
    private int mImageWidth = 720, mImageHeight = 1280; // bitmap图片实际大小
    ...
    @Override
    public void onAvailable(final Bitmap bitmap, final int w, final int h) {
        mRunOnDraw.add(new Runnable() {
            ...
            public void run() {
                ...
                mImageWidth = w;
                mImageHeight = h;
                mGLTextureId = com.uc.mamba.renderer.gpuimage.OpenGlUtils.loadTexture(bitmap, OpenGlUtils.NO_TEXTURE, true);
            }
        });
