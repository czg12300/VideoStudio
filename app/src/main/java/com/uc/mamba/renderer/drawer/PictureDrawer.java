...
import com.uc.mamba.renderer.GLImageHandler;
import com.uc.mamba.renderer.VideoFps;
...
public class PictureDrawer implements IDrawer {
    ...
    @Override
    public void onDraw(int textureId, Map<String,Object> extParams) {
        videoFps.printFps();
